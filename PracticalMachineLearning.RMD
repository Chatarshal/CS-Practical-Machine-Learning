...
##I loaded the data both from the provided training and test data provided. Some values contained a "#DIV/0!" that I replaced with an NA value.
...
##This model is very accurate, as it can be seen from the confusion matrix. I did experiment with PCA and other models, but did not get as good of accuracy. Because my test data was around 99% accurate I expected nearly all of the submitted test cases to be correct. It turned out they were all correct.
